...
<html>
    <head>
        ...
        <section style="height: 100vh; background-image : url(foto/background.jpg);" class="w-100 d-flex flex-column justify-content-center align-items-center">
        <h1>Selamat Datang !</h1>
        <div>
            <a class="js-scroll-trigger btn btn-lg btn-outline-dark " href="tampilProject.php">List Project</a>
            <a class="js-scroll-trigger btn btn-lg btn-outline-dark " href="tambahProject.php">Add New Project</a>
        </div>
    </section>
        </body>
</html>